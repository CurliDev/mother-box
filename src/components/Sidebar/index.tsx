...
import ArrowIcon from "@/statics/icons/arrow";
import DashboardIcon from "@/statics/icons/dashboard";
import UsersIcon from "@/statics/icons/users";
import BrushIcon from "@/statics/icons/brush";
import HelpIcon from "@/statics/icons/help";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute flex justify-between left-0 top-0 z-9999 flex h-screen w-75 flex-col overflow-y-hidden bg-midnightIndigo duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      <div className="">
        <div className="flex items-center justify-center gap-y-2 pt-4 pb-2 lg:pt-5">
          <Link href="/">
            <h1 className="font-libre-carlson font-bold text-3xl ml-[-8px] italic">
              FestBerry
            </h1>
          </Link>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-5 py-2 px-2 lg:mt-7 lg:px-6">
            <div>
